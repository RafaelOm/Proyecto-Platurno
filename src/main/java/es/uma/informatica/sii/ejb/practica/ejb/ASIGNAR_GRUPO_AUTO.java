...
import es.uma.informatica.sii.ejb.practica.ejb.exceptions.EncuestaNoExisteException;
...
public class ASIGNAR_GRUPO_AUTO implements ASIGNAR_GRUPO_AUTOInterfaz {
    ...
    @Override
    public void ASIGNAR(Usuario u, Expediente ex) throws EncuestaNoExisteException {
