...
/*	
	public Matricula(List<Objects> parameters) {
		this.Curso_Academico = (String) parameters.get(0);
		this.Estado = (String) parameters.get(1);
		this.Num_Archivo = (String) parameters.get(2);
		this.Turno_Preferente = (String) parameters.get(3);
		this.Fecha_Matricula = (Date) parameters.get(4);
		this.Nuevo_Ingreso = (String) parameters.get(5);
		this.Listado_de_Asignaturas = (String) parameters.get(6);	
	}
