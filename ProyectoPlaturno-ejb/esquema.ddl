...
CREATE TABLE Expediente (Expediente VARCHAR NOT NULL, Activo VARCHAR, CreditosCF DOUBLE, CreditosFB DOUBLE, CreditosOB DOUBLE, CreditosOP DOUBLE, CreditosPE DOUBLE, CreditosSup DOUBLE, CreditosTF DOUBLE, N_Archivo VARCHAR NOT NULL, NotaMPr DOUBLE, ALUMNO_PRUEBA VARCHAR, TITULACION_CODIGO INTEGER, PRIMARY KEY (Expediente))
...
ALTER TABLE Expediente ADD CONSTRAINT FK_Expediente_ALUMNO_PRUEBA FOREIGN KEY (ALUMNO_PRUEBA) REFERENCES ALUMNO (PRUEBA)
