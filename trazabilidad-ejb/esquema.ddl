...
CREATE TABLE SECRETARIA (USERNAME VARCHAR NOT NULL, APELLIDO VARCHAR, PASSWORD VARCHAR NOT NULL, VALIDATIONCHAIN VARCHAR, DNI VARCHAR, EMAIL VARCHAR, IDENTIFICADOR BIGINT, NOMBRE VARCHAR, PRIMARY KEY (USERNAME))
