...
CREATE TABLE ENCUESTA_Gr_Asig (Encuesta_Id_Encuesta VARCHAR NOT NULL, CURSO_ACT INTEGER NOT NULL, ASIG_Referencia VARCHAR NOT NULL, GROUP_ID VARCHAR NOT NULL, PRIMARY KEY (Encuesta_Id_Encuesta, CURSO_ACT, ASIG_Referencia, GROUP_ID))
...
CREATE TABLE Gr_Asig_ENCUESTA (CURSO_ACT INTEGER NOT NULL, ASIG_Referencia VARCHAR NOT NULL, GROUP_ID VARCHAR NOT NULL, encuestas_Id_Encuesta VARCHAR NOT NULL, PRIMARY KEY (CURSO_ACT, ASIG_Referencia, GROUP_ID, encuestas_Id_Encuesta))
...
ALTER TABLE Gr_Asig_ENCUESTA ADD CONSTRAINT FK_Gr_Asig_ENCUESTA_CURSO_ACT FOREIGN KEY (CURSO_ACT, ASIG_Referencia, GROUP_ID) REFERENCES Gr_Asig (CURSO_ACT, ASIG_Referencia, GROUP_ID)
ALTER TABLE Gr_Asig_ENCUESTA ADD CONSTRAINT FK_Gr_Asig_ENCUESTA_encuestas_Id_Encuesta FOREIGN KEY (encuestas_Id_Encuesta) REFERENCES ENCUESTA (Id_Encuesta)
